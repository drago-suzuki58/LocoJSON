...
# Create a LocoJSON object
loc = LocoJSON(system_locale)
...
def create_menu_labels():
    ...
    helpmenu.add_command(label=loc.label.help.about(), command=lambda: webbrowser.open("https://github.com/drago-suzuki58/LocoJSON"))
